# -*- coding: utf-8 -*-
# Generated by Django 1.9.4 on 2016-03-30 21:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_train_entity', models.ForeignKey(help_text='Where a train has had its identity changed, the current 10-character unique identity for this train', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='trainmovements.TrainEntity')),
                ('location_station', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='naptan.NaptanRailStation')),
                ('next_report_station', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='naptan.NaptanRailStation')),
                ...
                ('reporting_station', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='naptan.NaptanRailStation')),
            ],
            options={
                'abstract': False,
            },
